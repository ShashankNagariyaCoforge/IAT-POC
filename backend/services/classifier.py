...
- number_of_employees: Extract the total employee headcount as a single number. If only one count is given, return it as-is (e.g., "45", "120 FTEs", "approximately 200"). If multiple counts are given for different categories (e.g., "6 full-time and 1 part-time", "10 FT / 3 PT", "8 W-2 and 2 contractors"), add them together and return ONLY the total number (e.g., "7", "13", "10") — do NOT return the breakdown, do NOT return both numbers separately. DO NOT return the full question text, field label, or any surrounding form content.
